...
public class Launch {
	...
	public static void main(String[] args) throws IOException {
		...
		Runtime.getRuntime().addShutdownHook(new Thread() {
			public void run() {
				try {
					context.stop();
					context.close();
					logger.info("Service mongo-service stopped...");
					System.out.println("Service mongo-service stopped...");
				} catch (Exception t) {
		...
		// 启动spring
		context.start();
		logger.info("Service mongo-service started...");
		System.out.println("Service mongo-service started...");
